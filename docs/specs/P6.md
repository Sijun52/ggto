...
7. DESIGN 6절(트레이너)·8절 로드맵 P6 행, DECISIONS **다음 번호 두 개** (P7 스펙이 D30~D37 을 먼저 썼다 — 착수 시점의 다음 번호를 쓴다: 스팟은 한 솔브 안에서만 채점 — 1절 근거; 샘플링은 랜덤 워크 — 노드 열거 RPC 없음). 다이어그램 `docs/assets/p6-trainer-postflop-mobile.svg` 는 구현과 다르면 갱신 (D18).
8. 잔여 프로세스 0.
...
- DECISIONS 다음 번호 두 개 (7.4-7 — D30~D37 은 P7 이 썼다). D27 문구 정정 (12절 MINOR 11).
